class Movies {
  ...
  async insert(movie) {
    ...
    `, [
        movie.id, movie.title, movie.originalTitle, movie.fullTitle, movie.year, movie.image, movie.releaseDate, movie.runtimeStr, movie.plot, movie.awards, movie.directorList, movie.writerList, JSON.stringify(movie.actorList), movie.genreList, movie.companies, movie.countries, movie.languages, movie.imDbRating, JSON.stringify(movie.posters), JSON.stringify(movie.images), movie.boxOffice, movie.plotFull, movie.similars
    ]);
}
